...
namespace
{
bool parseCompoundIntegerString(const std::string &value)
{
    int result = 0;
    size_t start = 0;
...
bool TimeReader::parseTimeSignatureGroup(const core::TimeSignatureGroup &timeSig)
{
    ...
    if (!parseCompoundIntegerString(beatsStr))
    {
        return false;
    }

    myTimeSignatureData.beats = beatsStr;
...
//        bool TimeReader::findAndFillTimeSignature( const core::MusicDataChoice& inMdc, api::TimeSignatureData&
//        outTimeSignatureData ) const
//        {
...
//
//
//        bool TimeReader::isTimeSignatureImplicit( const api::TimeSignatureData& previousTimeSignature, const
...
//
//                        if( foundDivisions.find( tempDivInt ) == foundDivisions.end() )
//                        {
...
//        }
//
//        int TimeReader::convertDurationToGlobalTickScale( const impl::Cursor& cursor, const core::Duration& duration )
//        const
//        {
...
//        }
//
//        int TimeReader::convertDurationToGlobalTickScale( const impl::Cursor& cursor, long double durationValue )
//        const
//        {
