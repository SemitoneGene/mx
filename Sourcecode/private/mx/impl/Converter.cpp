...
namespace mx
{
    namespace impl
    {
        ...
        const std::map<core::TechnicalChoice::Choice, api::MarkType> Converter::technicalMarkMap =
        {
            ...
            std::pair<core::TechnicalChoice::Choice, api::MarkType>{ core::TechnicalChoice::Choice::fret, api::MarkType::fret },
            std::pair<core::TechnicalChoice::Choice, api::MarkType>{ core::TechnicalChoice::Choice::string_, api::MarkType::string_ },
